...
func initGPSSerial() bool {
	...
	if isSirfIV {
		...
		// The following lines are commented out to disable the ublox 8 multi-GNSS capability. This limits
		// the device to GPS only which seems to provide much better accuracy than the multi-GNSS mode.
